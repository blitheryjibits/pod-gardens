            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
              <div>
                ...
                <div className="space-y-6 text-on-surface-variant font-body leading-relaxed text-lg">
                  ...
                  <p>
                    We bridge the gap between architectural intent and
                    biological reality. Our expertise spans sophisticated
                    landscape design, heavy construction, and delicate
                    horticulture, ensuring every project is grounded in
                    structural integrity and botanical wisdom.
                  </p>
                  <p>
                    In addition to our large-scale works, our boutique indoor
                    plant studio serves as a sanctuary for those looking to
                    bring the serenity of the outdoors inside, curating rare
                    species that flourish in modern living spaces.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-on-surface-variant text-lg mb-8 leading-relaxed">
                    ...
                    perspective to the field, blending hands-on craftsmanship
                    with high-profile media experience. Their contributions to{" "}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-surface-container-lowest p-8 rounded-lg flex flex-col items-center text-center">
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  With decades of structural expertise, Steve ensures our
                  visions are built to withstand the elements.
                </p>
              </div>
              {/* <!-- Luke --> */}
              <div className="bg-surface-container-lowest p-8 rounded-lg flex flex-col items-center text-center">
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-lg text-on-surface-variant mb-10 leading-relaxed">
                While our roots are deep in Merimbula and the Bega Valley, we
                are nomadic in our pursuit of landscape excellence. We
                frequently take on projects across the Sapphire Coast and are
