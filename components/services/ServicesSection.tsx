      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-6 md:text-2xl">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <ServiceCard className="w-full md:w-3/5 bg-surface flex flex-col justify-between min-h-100">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-on-surface-variant max-w-sm">
                    From conceptual masterplans to detailed planting schedules,
                    we create spaces that breathe with the environment.
                  </p>
                </div>
            ...
            {/* Construction */}
            <ServiceCard className="flex-1 bg-primary  text-on-primary flex flex-col justify-between">
              ...
              <div>
                <p className="text-on-primary-container/80 mb-6">
                  Master craftsmanship using local stone, timber, and
                  sustainable materials built to survive the elements.
                </p>
                <a
          ...
          <div className="flex flex-col md:flex-row gap-6">
            {/* Horticulture */}
            <ServiceCard className="w-full md:w-2/5 bg-surface-container-high flex flex-col justify-between">
              <div>
                <h3 className="font-headline text-3xl text-primary font-bold mb-4">
                  Horticulture
                </h3>
            ...
            {/* Portfolio */}
            <ServiceCard className="flex-1 bg-secondary-container flex items-center justify-between group cursor-pointer">
              <div>
              ...
              <div className="w-1/3 md:w-1/4 lg:w-1/5 aspect-square p-2 flex text-center items-center rounded-full bg-secondary text-on-secondary">
                <span className="m-auto material-symbols-outlined text-3xl! md:text-5xl!">
                  visibility
                </span>
              </div>
            </ServiceCard>
